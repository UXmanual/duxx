 ...
 * @description 사용자 요청에 따른 폰트 사이즈(14px) 및 레터 스패싱(0) 조정 버전입니다.
 */
const Footer = () => {
  return (
    <footer className="fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="flex flex-col items-start gap-1 backdrop-blur-sm bg-theme-bg/10 p-5 rounded-[32px] inline-block pointer-events-auto">
